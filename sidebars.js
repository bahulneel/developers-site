...
module.exports = {
  ...
  guides: [
    "guides/guides",
    {
      ...
      label: "Schema",
      collapsed: false,
      items: [{ type: "autogenerated", dirName: "guides/schema" }],
    },
    {
      type: "category",
      label: "Transactions",
      items: [{ type: "autogenerated", dirName: "guides/transactions" }],
    },
    {
      type: "category",
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            {
              type: "autogenerated",
              dirName: "guides/querying/query-intermediate",
            },
          ],
        },
        {
          ...
          items: [
            {
              type: "autogenerated",
              dirName: "guides/querying/query-advanced",
            },
          ],
        },
      ],
    },
    {type: "category", label: "JSON-LD", items: [{type: "autogenerated", dirName: "guides/json-ld"}]},
    {
      type: "category",
      label: "GraphQL",
      items: [{ type: "autogenerated", dirName: "guides/graphql" }],
    },
    {
      type: "category",
      label: "SPARQL",
      items: [{ type: "autogenerated", dirName: "guides/sparql" }],
    },
    {
      type: "category",
      ...
      items: [
        {
          type: "category",
          label: "API",
          items: [{ type: "autogenerated", dirName: "guides/advanced/api" }],
        },
        {
          type: "category",
          label: "Cryptography",
        ...
        },
        {
          ...
          items: [
            {
              type: "autogenerated",
              dirName: "guides/advanced/flakes-and-blocks",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            {
              type: "autogenerated",
              dirName: "guides/advanced/smart-functions",
            },
          ],
        },
      ],
  ...
  concepts: [
    ...
    "concepts/technical_overview",
    {
      type: "category",
      label: "Core Concepts",
      items: [{ type: "autogenerated", dirName: "concepts/core-concepts" }],
    },
    {
      type: "category",
      label: "Infrastructure",
      items: [{ type: "autogenerated", dirName: "concepts/infrastructure" }],
    },
    {
      type: "category",
      label: "Identity",
      items: [{ type: "autogenerated", dirName: "concepts/identity" }],
    },
    {
      type: "category",
      label: "Smart Functions",
      items: [{ type: "autogenerated", dirName: "concepts/smart-functions" }],
    },
    {
      type: "category",
  ...
  nexus: [
    "nexus/getting_started",
    {
      type: "category",
      label: "Dataset Pages",
      items: [{ type: "autogenerated", dirName: "nexus/dataset-pages" }],
    },
    {
      type: "category",
      label: "Connecting to Nexus",
      items: [{ type: "autogenerated", dirName: "nexus/connecting-to-nexus" }],
    },
  ],
};
